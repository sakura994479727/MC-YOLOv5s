# nohup python -m torch.distributed.launch --nproc_per_node 2 --master_port 2000 train.py --data VisDrone.yaml --weights yolov5s.pt --cfg models/yolov5l.yaml --epochs 300 --batch-size 8 --img 608 --nosave --device 2,3 --sync-bn >> yolov5s.out &
...
# nohup python -m torch.distributed.launch --nproc_per_node 1 --master_port 2002 train.py --data VisDrone.yaml --weights yolov5x.pt --cfg models/yolov5lP2.yaml --epochs 300 --batch-size 8 --img 640 --nosave --device 0,3 --sync-bn >> yolov5xP2.out &
# nohup python -m torch.distributed.launch --nproc_per_node 2 --master_port 2000 train.py --data VisDrone.yaml --weights yolov5x.pt --cfg models/yolov5lP2CBAM.yaml --epochs 300 --batch-size 8 --img 640 --nosave --device 2,3 --sync-bn >> yolov5xP2CBAM.out &
# nohup python -m torch.distributed.launch --nproc_per_node 2 --master_port 2000 train.py --data VisDrone.yaml --weights yolov5x.pt --cfg models/accModels/yolov5lP2CBAM-TPH-BiFPN-SPP.yaml --hyp data/hyps/hyp.visdrone.yaml --epochs 80 --batch-size 4 --img 1536 --device 0,1 --sync-bn --adam --name v5x-TPH >> yolov5xTPH.out &
...
# nohup python -m torch.distributed.launch --nproc_per_node 2 --master_port 2006 train.py --data VisDrone.yaml --weights yolov5l.pt --cfg models/lightModels/yolov5lMobilenetv3Small-BiFPN.yaml --epochs 300 --batch-size 8 --img 640 --nosave --device 0,1 --sync-bn >> yolov5lMobilenetv3Small.out &
...
# nohup python -m torch.distributed.launch --nproc_per_node 2 --master_port 2000 train.py --data VisDrone.yaml --weights yolov5l.pt --cfg models/lightModels/yolov5sPP-LC.yaml --epochs 300 --batch-size 8 --img 640 --nosave --device 0,3 --sync-bn >> yolov5lPP-LC.out &
